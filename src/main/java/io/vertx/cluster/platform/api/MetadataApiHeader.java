...
public final class MetadataApiHeader extends MainApiHeader {
    private MetadataApiHeader(String name, String value) {
        super(name, value);
    }
    
    private MetadataApiHeader(String name, Iterable<String> values) {
        super(name, values);
    }
